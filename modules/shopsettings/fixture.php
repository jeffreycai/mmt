...
if (is_cli()) {
  ...
  $settings->setShopIntroduction("我们是澳大利亚价格最实惠的保健品批发和零售代理商.我们的专业代理可以拿到比其他保健品销售商更低的价格.如果您是批量购买,还有优惠哦~!\n\n我们在Hursville有实体店,店的地址是xxxxx,欢迎广大新老客户上门选购.");
  $settings->setShopWechat('aixinliping');
  $settings->setShopPhone('1300 887 889');
  $settings->setShopAddress('Level 4, 34 Pacific Highway, Hursville');
  $settings->setShopEmail('aixinliping@gmail.com');
