<div class="body">
  ...
  <div class="row list section">
    ...
    <div class="col-xs-12">
      <a href="<?php echo uri('user/shop/payment') ?>">支付设置 <?php echo $user->hasPermission('use payment function') ? ($user->isPaymentSet() ? '' : '<span>未设置</span>') : '<span>未开通</span>' ?><i class="fa fa-angle-right"></i></a>
    </div>
    <div class="col-xs-12">
