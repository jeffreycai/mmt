...
if (isset($_POST['submit'])) {
  ...
  if ($error_flag == false) {
    if ($object->save()) {
      Message::register(new Message(Message::SUCCESS, i18n(array("en" => "Product has been successfully edited.", "zh" => "商品修改成功！<br /><small><a href='".$object->getPreviewUri()."' target='_blank'>预览商品 &raquo;</a></small>"))));
