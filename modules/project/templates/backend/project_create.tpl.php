...
<div class='hr-line-dashed'></div>
    ...
    <script type='text/javascript'>
      $('#OXFGE .datepicker').datepicker({
        dateFormat: '@'
        ,altField: "#OXFGE .altFormat", altFormat: "yy-mm-dd"
        ,changeMonth: 1
        ,changeYear: 1
        ,yearRange: 'c-5:c+10'
      });
      $('#OXFGE .input-group-addon').css('cursor', 'pointer').on('click', function(){
        $('#OXFGE .datepicker').datepicker('show');
      });
    </script>
