...
<div class='hr-line-dashed'></div>
    ...
    <script type='text/javascript'>
      $('#RK2jI .datepicker').datepicker({
        dateFormat: '@'
        ,altField: "#RK2jI .altFormat", altFormat: "yy-mm-dd"
        ,changeMonth: 1
        ,changeYear: 1
        ,yearRange: 'c-5:c+10'
      });
      $('#RK2jI .input-group-addon').css('cursor', 'pointer').on('click', function(){
        $('#RK2jI .datepicker').datepicker('show');
      });
    </script>
